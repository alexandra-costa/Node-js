...
function render() {
  ...
  listArr.forEach((element) => {
    ...
    <span style="color: rgb(56, 9, 46); cursor:pointer; -webkit-text-stroke-width: thick; border: 1px solid black; border-radius: 8px; margin: 18px;" class="span-close" id="${element.id}"> Excluir </span>
    <span id="${element.id}" style="color: rgb(155, 79, 145); cursor:pointer; -webkit-text-stroke-width: thick; border: 1px solid black; border-radius: 8px; margin: 18px;" class="span-edit">Salvar</span>`;
    myUL.appendChild(li);
    inputValue.value = "";
  });
  deleteAll();
